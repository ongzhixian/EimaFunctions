...
public class SemVerApi(ILogger<SemVerApi> logger)
{
    [Function("RegisterSemVer")]
    [OpenApiOperation(operationId: "RegisterSemVer")]
    ...
    public async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "sem-ver/")] HttpRequest req)
    {
